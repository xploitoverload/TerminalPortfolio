// src/components/Terminal/commands/Themes.tsx
...
const Themes: React.FC = () => {
    ...
    useEffect(() => {
        if (currentCommand[0] === "themes" && currentCommand.length === 1) {
            themeSwitcher?.(defaultTheme);
        } else if (checkThemeSwitch(rerender, currentCommand, myThemes)) {
